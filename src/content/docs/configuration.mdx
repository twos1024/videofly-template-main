...
description: How to configure pricing, credits, AI models, and admin access in PexelMuse.
---

# Configuration Guide

This guide explains how to configure pricing, credits, AI models, and admin access in PexelMuse.
