      ...
      <div className="relative mx-auto my-12 flex w-full max-w-7xl flex-1 flex-col px-4 py-0 sm:my-10 md:my-20 lg:px-4">
        ...
        <div className="my-8 flex justify-center">
          <div className="inline-flex rounded-lg bg-muted p-1">
            ...
            >
              {dictPrice.tab_onetime}
            </TabButton>
            <TabButton
              active={activeTab === "monthly"}
              onClick={() => setActiveTab("monthly")}
            >
              {dictPrice.tab_monthly}
            </TabButton>
            <TabButton
              active={activeTab === "yearly"}
              onClick={() => setActiveTab("yearly")}
              showBadge
              badgeText={dictPrice.off_percent}
            >
...
function TabButton({ active, children, onClick, showBadge, badgeText }: TabButtonProps) {
  return (
    <button
      onClick={onClick}
      className={cn(
