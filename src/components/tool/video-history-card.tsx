...
import { Copy, AlertCircle, Clock, PlayCircle } from "lucide-react";
        ...
        <div className="relative aspect-video bg-black">
          {video.videoUrl ? (
            shouldRenderVideo ? (
              ...
              <button
                type="button"
                onClick={() => setShouldRenderVideo(true)}
                className="group relative h-full w-full text-left"
              >
                {video.thumbnailUrl ? (
                  <img
                    src={video.thumbnailUrl}
                    alt={video.prompt || t("resultAlt")}
                ...
                <div className="absolute inset-0 bg-black/35 transition-colors group-hover:bg-black/45 flex items-center justify-center">
                  <span className="inline-flex items-center gap-1.5 rounded-full bg-white/15 px-3 py-1.5 text-xs text-white backdrop-blur-sm">
